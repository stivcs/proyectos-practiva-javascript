...
const calculateFactorialForEachArrayValue = () => {
	console.log("Arreglo de factoriales de la parte entera de cada valor")
	for (let i = 0; i < array.length; i++) {
		for (let j = 0; j < array[i].length; j++) {
...
const promedioMayoresFila = () => {
	...
	// console.log(`${mayores}`);
	console.log(`\nPromedio de los valores mas altos de filas: ${(cont / 8).toFixed(1)}`);
};
...
const promedioMayoresColumna = () => {
	...
	console.log(`\nPromedio de los valores mas altos de Columnas: ${(cont / 8).toFixed(1)}`);
};
