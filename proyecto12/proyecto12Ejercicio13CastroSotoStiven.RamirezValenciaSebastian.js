...
- Lenguaje utilizado JavaScriptnosd 
- Version del lenguaje 6.0 
- Presentado a: Doctor Ricardo Moreno Laverde
- Universidad Tecnológica de Pereira
- Programa de Ingeniería de Sistemas y Computación
- Hacer un programa diseñado para imprimir un 
triangulo invertido con espacios fijos a la izquierda
  */
...
const espacios = (cant, cont) => {
  ...
  const figura = (cant, esp) => {
    while (cant >= 1) {
      ...
      esp = esp + 1; // Incrementar la cantidad de espacios para la siguiente iteración
    }
  };
